...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '10be12c65abc80ae840fd73b197afd8d,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SuperWang', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://toolyuan.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'SuperWang, Blog', // 网站关键词 英文逗号隔开
